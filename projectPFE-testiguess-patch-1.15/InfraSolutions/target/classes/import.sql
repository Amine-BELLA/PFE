...
INSERT INTO equipement (id, fournisseur, mode, model, lat, lng, CoordonneePK, num_serie, reseau_id)VALUES (4, 'fournisseur1', 'CB', 'model1','33.971588', '-6.849813','PK10+10', 'serie1',3);
INSERT INTO equipement (id, fournisseur, mode, model, lat, lng, CoordonneePK, num_serie, reseau_id)VALUES (5, 'fournisseur2', 'CB', 'model2','33.573109', '-7.589843','PK15+50', 'serie2',3);
