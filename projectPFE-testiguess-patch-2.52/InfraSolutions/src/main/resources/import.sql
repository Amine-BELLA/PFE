...
INSERT INTO voie (id, numero, sens, reseau_id)VALUES (8, 1, 'BA', 3);

INSERT INTO voie (id, numero, sens, reseau_id)VALUES (9, 2, 'BA', 3);
...
INSERT INTO passage (id, classe_vehicule, date, gap, gross, headway, overloaded, speed_kmh, timestamp, time, type_poids, equip_id , voie_id, vehicule_id)Values(1, 'EU13-1', '2020-01-20', 120, 3500, 200, false, 90,'2020-01-20 02:12:11' ,'02:12:11', 'PL', 4, 6, 15);

INSERT INTO passage (id, classe_vehicule, date, gap, gross, headway, overloaded, speed_kmh,timestamp, time, type_poids, equip_id , voie_id, vehicule_id)Values(2, 'EU13-3', '2020-02-20', 120, 4000, 210, false, 90,'2020-02-20 02:12:11', '02:12:11', 'PL', 4, 7, 10);

INSERT INTO passage (id, classe_vehicule, date, gap, gross, headway, overloaded, speed_kmh,timestamp, time, type_poids, equip_id , voie_id, vehicule_id)Values(20, 'EU13-1', '2020-01-20', 120, 300, 200, false, 90,'2020-01-20 02:12:11' ,'02:12:11', 'VL', 5, 6, 11);